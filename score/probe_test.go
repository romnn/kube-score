...
func TestProbesPodIdenticalHTTP(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-identical-http.yaml",
		"Pod Probes",
		scorecard.GradeCritical,
	)
	assert.Len(t, comments, 1)
...
func TestProbesPodIdenticalExec(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-identical-exec.yaml",
		"Pod Probes",
		scorecard.GradeCritical,
	)
	assert.Len(t, comments, 1)
...
func TestProbesTargetedByService(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-targeted-by-service.yaml",
		"Pod Probes",
		scorecard.GradeCritical,
	)
	assert.Len(t, comments, 1)
...
func TestProbesTargetedByServiceSameNamespace(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-targeted-by-service-same-namespace.yaml",
		"Pod Probes",
		scorecard.GradeCritical,
	)
	assert.Len(t, comments, 1)
...
func TestProbesTargetedByServiceSameNamespaceMultiLabels(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-targeted-by-service-same-namespace-multi-labels.yaml",
		"Pod Probes",
		scorecard.GradeCritical,
	)
	assert.Len(t, comments, 1)
...
func TestProbesTargetedByServiceDifferentNamespace(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-targeted-by-service-different-namespace.yaml",
		"Pod Probes",
...
func TestProbesTargetedByServiceNotTargeted(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-not-targeted-by-service.yaml",
		"Pod Probes",
		scorecard.GradeAllOK,
	)
	assert.Len(t, comments, 1)
...
func TestProbesTargetedByServiceNotTargetedMultiLabels(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-not-targeted-by-service-multi-labels.yaml",
		"Pod Probes",
		scorecard.GradeAllOK,
	)
	assert.Len(t, comments, 1)
...
func TestProbesMultipleContainers(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-on-different-containers.yaml",
		"Pod Probes",
		scorecard.GradeAllOK,
	)
...
func TestProbesMultipleContainersInit(t *testing.T) {
	...
	comments := testExpectedScore(
		t,
		"pod-probes-on-different-containers-init.yaml",
		"Pod Probes",
		scorecard.GradeAllOK,
	)
	assert.Len(t, comments, 0)
