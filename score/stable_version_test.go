...
func TestStatefulSetAppsv1beta1Kubernetes1dot4(t *testing.T) {
	...
	testExpectedScoreWithConfig(
		t,
		[]ks.NamedReader{testFile("statefulset-appsv1beta1.yaml")},
		nil,
...
func TestDaemonSetExtensionsv1beta1(t *testing.T) {
	...
	testExpectedScore(
		t,
		"daemonset-extensionsv1beta1.yaml",
		"Stable version",
		scorecard.GradeWarning,
	)
}
...
func TestCronJobBatchv1beta1Kubernetes1dot21(t *testing.T) {
	...
	testExpectedScoreWithConfig(
		t,
		[]ks.NamedReader{testFile("cronjob-batchv1beta1.yaml")},
		nil,
		&config.RunConfiguration{
