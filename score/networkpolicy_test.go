...
func TestPodHasNoMatchingNetworkPolicy(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-not-matching.yaml",
		"Pod NetworkPolicy",
...
func TestPodHasMatchingIngressNetworkPolicy(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-matching-only-ingress.yaml",
		"Pod NetworkPolicy",
...
func TestPodHasMatchingEgressNetworkPolicy(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-matching-only-egress.yaml",
		"Pod NetworkPolicy",
		scorecard.GradeWarning,
	)
}
...
func TestNetworkPolicyTargetsPod(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-targets-pod.yaml",
...
func TestNetworkPolicyTargetsPodInDeployment(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-targets-pod-deployment.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeAllOK,
	)
}
...
func TestNetworkPolicyTargetsPodNotMatching(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-targets-pod-not-matching.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeCritical,
	)
}
...
func TestNetworkPolicyDeploymentNamespaceMatching(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-deployment-matching.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeAllOK,
	)
	testExpectedScore(
...
func TestNetworkPolicyStatefulSetNamespaceMatching(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-statefulset-matching.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeAllOK,
	)
	testExpectedScore(
...
func TestNetworkPolicyCronJobNamespaceMatching(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-cronjob-matching.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeAllOK,
	)
	testExpectedScore(
...
func TestNetworkPolicyDeploymentNamespaceNotMatchingSelector(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-deployment-not-matching-selector.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeCritical,
	)
	testExpectedScore(
...
func TestNetworkPolicyStatefulSetNamespaceNotMatchingSelector(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-statefulset-not-matching-selector.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeCritical,
	)
	testExpectedScore(
...
func TestNetworkPolicyCronJobNamespaceNotMatchingSelector(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-cronjob-not-matching-selector.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeCritical,
	)
	testExpectedScore(
...
func TestNetworkPolicyEmptyPodSelector(t *testing.T) {
	...
	testExpectedScore(
		t,
		"networkpolicy-targets-all-pods.yaml",
		"NetworkPolicy targets Pod",
		scorecard.GradeAllOK,
	)
	testExpectedScore(
