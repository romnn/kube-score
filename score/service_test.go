...
func TestServiceNotTargetsPodDeployment(t *testing.T) {
	...
	testExpectedScore(
		t,
		"service-not-target-deployment.yaml",
		"Service Targets Pod",
...
func TestServiceTargetsPodRawMultiLabel(t *testing.T) {
	...
	testExpectedScore(
		t,
		"service-target-pod-multi-label.yaml",
		"Service Targets Pod",
		scorecard.GradeAllOK,
	)
}
...
func TestServiceNotTargetsPodRawMultiLabel(t *testing.T) {
	...
	testExpectedScore(
		t,
		"service-not-target-pod-multi-label.yaml",
		"Service Targets Pod",
		scorecard.GradeCritical,
	)
}
...
func TestServiceTargetsPodRawSameNamespace(t *testing.T) {
	...
	testExpectedScore(
		t,
		"service-target-pod-same-namespace.yaml",
		"Service Targets Pod",
		scorecard.GradeAllOK,
	)
}
...
func TestServiceTargetsPodRawDifferentNamespace(t *testing.T) {
	...
	testExpectedScore(
		t,
		"service-target-pod-different-namespace.yaml",
		"Service Targets Pod",
		scorecard.GradeCritical,
	)
}
...
func TestServiceTargetsPodDeploymentSameNamespace(t *testing.T) {
	...
	testExpectedScore(
		t,
		"service-target-deployment-same-namespace.yaml",
		"Service Targets Pod",
		scorecard.GradeAllOK,
	)
}
...
func TestServiceTargetsPodDeploymentDifferentNamespace(t *testing.T) {
	...
	testExpectedScore(
		t,
		"service-target-deployment-different-namespace.yaml",
		"Service Targets Pod",
		scorecard.GradeCritical,
	)
}
